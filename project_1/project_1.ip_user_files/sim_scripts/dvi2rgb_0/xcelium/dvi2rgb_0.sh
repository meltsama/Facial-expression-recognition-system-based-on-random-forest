...
#
# Script generated by Vivado on Tue Mar 18 22:07:42 +0800 2025
...
#
# Usage        : dvi2rgb_0.sh
#                dvi2rgb_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dvi2rgb_0.sh [-reset_run]
#                dvi2rgb_0.sh [-reset_log]
#                dvi2rgb_0.sh [-help]
#
...
#                script (type 'dvi2rgb_0.sh -help' for more information).
#
...
# script info
echo -e "dvi2rgb_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dvi2rgb_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dvi2rgb_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dvi2rgb_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dvi2rgb_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dvi2rgb_0.sh [-step]\n\
Usage: dvi2rgb_0.sh [-lib_map_path]\n\
Usage: dvi2rgb_0.sh [-reset_run]\n\
Usage: dvi2rgb_0.sh [-reset_log]\n\
Usage: dvi2rgb_0.sh [-keep_index]\n\
